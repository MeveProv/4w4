<footer class="site__footer">
    <h2 class="footer__titre">Travaux des cours de la technique d'intégration multimédia</h2>
    <p class="footer__presentation">Premier site web fait à l'aide de WORDPRESS</p>
    <h3 class="footer__author">Site de Marie-Eve Provost</h3>
    <div class="iconeFooter">
   
   <a[ href="#" class ="iconeFooter__lien">
